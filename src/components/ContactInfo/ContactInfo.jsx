...
const ContactInfo = ({ isMobile = false }) => (
  <Flex direction={isMobile ? "column" : "row"} justify={isMobile ? "center" : "space-between"} align="center" gap="md" w="100%">
    <Text c="gray" fw={500} size={isMobile ? "sm" : "md"} ta={isMobile ? "center" : "left"}>
      Made by{" "}
      <Anchor fw={700} fz={isMobile ? "20px" : "18"} href="https://github.com/galraij" target="_blank">
        Gal
      </Anchor>
      ,{" "}
      <Anchor fw={700} fz={isMobile ? "20px" : "18"} href="https://github.com/TOMLUCA7" target="_blank">
        Tom
      </Anchor>{" "}
      and{" "}
      <Anchor fw={700} fz={isMobile ? "20px" : "18"} href="https://github.com/MarkDavidovich" target="_blank">
        Mark
      </Anchor>
    </Text>
